...
<html>
    ...
    <body>
        ...
        <div class="nav" role="navigation">
            ...
            <div id="create-cliente" class="content scaffold-create col-lg-11" role="main">
                ...
                <div class="panel-body">
                    ...
                    <g:form url="[resource:clienteInstance, action:'save']" class="form-horizontal" role="form" >
                        <fieldset class="form">
