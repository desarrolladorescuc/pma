...
<html>
    ...
    <body>
        ...
        <div id="create-incidente" class="content scaffold-create col-lg-11" role="main">
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    ...
                    <g:form url="[resource:incidenteInstance, action:'save']" class="form-horizontal" role="form" >
                        <fieldset class="form">
