...
<html>
    ...
    <body>
        ...
        <div class="nav" role="navigation">
            ...
            <div id="edit-incidente" class="content scaffold-edit col-lg-11" role="main">
                ...
                <div class="panel-body">
                    ...
                    <g:form url="[resource:incidenteInstance, action:'update']" method="PUT" class="form-horizontal" role="form">
